...
import { FragmentImport, ImportDeclaration } from "./imports";
import { convertName } from "./naming";
import {
  ConvertFn,
  ConvertOptions,
  DeclarationKind,
...
> {
  ...
  public convertName(
    ...
    const useTypesPrefix =
      typeof options?.useTypesPrefix === "boolean"
        ? options.useTypesPrefix
        : true;
    const useTypesSuffix =
      typeof options?.useTypesSuffix === "boolean"
  ...
  public getOperationSuffix(
    ...
    const { omitOperationSuffix = false, dedupeOperationSuffix = false } = this
  ...
  public getFragmentVariableName(
